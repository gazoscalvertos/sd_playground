...
download_models_from_config() {
    ...
    download_model_type "esrgan_models" "models" "$config_file" "$hf_token" "$civitai_token"
    download_model_type "unet_models" "unet" "$config_file" "$hf_token" "$civitai_token"
    download_model_type "vae_models" "vae" "$config_file" "$hf_token" "$civitai_token"
    download_model_type "lora_models" "lora" "$config_file" "$hf_token" "$civitai_token"
    download_model_type "clip_models" "clip" "$config_file" "$hf_token" "$civitai_token"
}
